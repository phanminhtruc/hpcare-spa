...
export default function Header() {
  ...
  return (
    <div className='bg-be pb-5 pt-2 text-white'>
      <div className='container'>
        <NavHeader />
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to='/' className='col-span-3'>
            <img src="src\assets\images\logo.png" alt="HP CARE - SPA" className='w-3/4 h-3/4'/>
          
          </Link>
          <div className='col-span-8'>
            <div className='flex justify-center items-center overflow-hidden rounded-sm bg-white p-1 h-60'>
              <div className='w-full flex overflow-hidden'>
                <img src='https://placekitten.com/200/300' className='w-full transition-all duration-3000 ease-in-out' />
                <img src='https://placekitten.com/200/301' className='w-full transition-all duration-3000 ease-in-out' />
                <img src='https://placekitten.com/200/302' className='w-full transition-all duration-3000 ease-in-out' />
              </div>
            </div>
